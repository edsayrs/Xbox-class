...
{
    public class newGameSingle:Screen
    {
        ...
        Ball ball;
        Texture2D bgi;
        public newGameSingle(Game game,Paddle _computer_paddle,Paddle _player_paddle,Song _bgm, SoundEffect _p1, SoundEffect _p2, SoundEffect _ballhit, Ball _ball,GraphicsDeviceManager _graphics,SpriteBatch _spriteBatch,Texture2D _bgi)
            : base(game)
        {
